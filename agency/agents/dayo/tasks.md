...
- [ ] **TASK-D-002**: Write content brief + headline options for blog #1: "9 Lies Car Dealers Tell"
  ...
  - Priority: Critical
  - Deadline: 2026-03-11
  - Dependencies: TASK-C-003 (SEO brief from Chidi)
  - Output: marketing/campaigns/trust-awareness-m1/creative/brief-9-lies.md
  - Status: ASSIGNED

- [ ] **TASK-D-003**: Write content brief + headline options for blog #2: "Tokunbo Inspection Checklist"
  - Brief: Same format as TASK-D-002. Focus on: practical utility (this should be the checklist people screenshot and take to the car lot), headline angles (authority, completeness, timeliness — "2026"), visual structure ideas (numbered steps, checkbox format, photos of what to look for), psychological framing (confidence through preparation, not paranoia).
  - Priority: High
  - Deadline: 2026-03-12
  - Dependencies: TASK-C-004 (SEO brief from Chidi)
